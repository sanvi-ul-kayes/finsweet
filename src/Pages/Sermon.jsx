...
const Sermon = () => {
  return (
    <div className="bg-[#E5E5E5] pt-[128px]">
      ...
      <div className="flex justify-center mt-[64px]  pb-[128px] relative">
        <div className="w-[435px] px-[90px] py-[61px] bg-[#FFF5EB] ">
          ...
          <Button
            ...
            Navname="Register"
          />
          <div className="absolute top-0 left-[1013px] ">
        ...
        <div className="relative">
          ...
          <div className="flex items-center text-center gap-[11px] absolute bottom-[-48px] right-0">
